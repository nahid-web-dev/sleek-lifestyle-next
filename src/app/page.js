      ...
      <div className="flex flex-col gap-5 my-10 items-center md:w-[80%] mx-auto px-4 sm:px-6">
        ...
        <div className="bg-gray-50 py-12 px-4 sm:px-6 md:px-16 lg:px-32">
          ...
          <p className="text-lg md:text-xl text-gray-600 text-center mb-12">
            At <span className="text-blue-500 font-semibold">Sleek-Lifestyle</span>, we believe that style is more than what you wear—it's a way of living. Our mission goes beyond offering premium menswear; we strive to inspire confidence, success, and individuality through every piece we create.
          </p>
        ...
        <div className="p-4 md:w-[80%] mx-auto text-left">
          ...
          <h3>At <Link href="/shop" className="text-2xl text-blue-700 underline mx-3">Sleek-Lifestyle,</Link> we're dedicated to providing high-quality fashion that combines sophistication, comfort, and local craftsmanship. Here's why Sleek-Lifestyle is the perfect choice for the modern man:</h3>
          <ul className="list-disc list-inside space-y-3 text-gray-700 mt-5">
            ...
            <li>
              <span className="font-bold">Top-Quality Fabrics:</span> We believe that luxury begins with quality. That's why we use premium fabrics, designed to last and look sharp wear after wear.
            </li>
            <li>
